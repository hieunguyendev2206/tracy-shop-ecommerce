...
namespace TracyShop.Services
{
    public class EmailService : IEmailService
    {
        ...
        {
            userEmailOptions.Subject =
                UpdatePlaceHolders("Hello {{UserName}}, This is test email subject from Tracy Shop",
        ...
        {
            userEmailOptions.Subject =
                UpdatePlaceHolders("Hello {{UserName}}, reset your password.", userEmailOptions.PlaceHolders);
        ...
        {
            userEmailOptions.Subject = UpdatePlaceHolders("Hello {{UserName}}, payment confirmation.",
                userEmailOptions.PlaceHolders);
        ...
        private async Task SendEmail(UserEmailOptions userEmailOptions)
        {
            ...
            foreach (var toEmail in userEmailOptions.ToEmails) mail.To.Add(toEmail);
