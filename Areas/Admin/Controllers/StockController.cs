    ...
    public class StockController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            foreach (var product in products)
            {
                ...
                var total = 0;
                foreach (var item in productSizes) total += item.Quantity;
        ...
        {
            var stockReceived = _context.StockReceived.ToList();
        ...
        {
            var productStock = new ProductStockItem();
        ...
        public async Task<IActionResult> StockReceived(ProductStockItem productStock)
        {
            ...
            var receivedDetail = new StockReceivedDetail();
            if (ModelState.IsValid)
            {
                product = _context.ProductSize.FirstOrDefault(p =>
                    p.ProductId == productStock.SelectedPro && p.SizeId == productStock.SelectedSize);
