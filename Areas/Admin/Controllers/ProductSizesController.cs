    ...
    public class ProductSizesController : Controller
    {
        ...
        public async Task<IActionResult> Create(ProductSizeModel productSize)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                product.Quantity = 0;
                var pro = _context.ProductSize
                    .Where(p => p.ProductId == product.ProductId && p.SizeId == product.SizeId).FirstOrDefault();
                ...
                ViewBag.Message =
                    "Thêm không thành công vì size của sản phẩm này đã tồn tại. Vui lòng kiểm tra lại.";
                return View(product);
            }
