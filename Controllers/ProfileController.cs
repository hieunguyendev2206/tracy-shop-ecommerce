    ...
    public class ProfileController : Controller
    {
        ...
        public async Task<IActionResult> Profile(ProfileModel userdetails)
        {
            ...
            if (userdetails.AvatarPath != null)
            {
                ...
                var filePath = Path.Combine(wwwRootPath + "/img/avatar/", fileName);
        ...
        public IActionResult ChangeAddress()
        {
            ...
            if (address.Count() == 0) return View();
        ...
        public IActionResult PurchaseHistory()
        {
            ...
            else
            {
                ...
                foreach (var item in order)
                {
                    ...
                    foreach (var detail in orderDetail) total += detail.Price * detail.Quantity;
        ...
        public async Task<IActionResult> CancelOrder(int orderId)
        {
            ...
            {
                var proSize = _context.ProductSize.FirstOrDefault(p =>
                    p.ProductId == item.ProductId && p.SizeId == item.SelectedSize);
